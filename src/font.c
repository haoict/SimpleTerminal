...
void draw_char(SDL_Surface *surface, unsigned char symbol, int x, int y, unsigned short color, int embedded_font_name) {
    ...
    const unsigned char *ptr = (embedded_font_name == 1 ? embedded_font1 : embedded_font2) + symbol * 8;
    for (int i = 0, ys = 0; i < (embedded_font_name == 1 ? 6 : 8); i++, ptr++, ys += 1)
...
int get_embedded_font_char_width(int embedded_font_name) { return 6; }

int get_embedded_font_char_height(int embedded_font_name) { return embedded_font_name == 1 ? 8 : 10; }
