...
#ifdef RG35XX
//	RG35xx
#define KEY_UP SDLK_KATAKANA
#define KEY_DOWN SDLK_HIRAGANA
#define KEY_LEFT SDLK_HENKAN
#define KEY_RIGHT SDLK_KATAKANAHIRAGANA
#define KEY_ENTER SDLK_MUHENKAN // A
#define KEY_TOGGLE SDLK_KP_JPCOMMA // B
#define KEY_BACKSPACE SDLK_BREAK // R
#define KEY_SHIFT SDLK_RALT // L
#define KEY_LOCATION SDLK_RCTRL // Y
#define KEY_ACTIVATE SDLK_KP_ENTER // X
#define KEY_QUIT SDLK_PAGEUP // MENU
#define KEY_TAB SDLK_PRINT // SELECT
#define KEY_RETURN SDLK_KP_DIVIDE // START
#define KEY_ARROW_LEFT SDLK_HOME // L2
#define KEY_ARROW_RIGHT	SDLK_CURSORBLOCKUP // R2
